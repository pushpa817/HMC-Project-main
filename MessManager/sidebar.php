<div class="sidebar" id="sidebar">
    ...
    <div class="top-section">
        ...
        <div class="user-details">
            ...
            <span class="name"><?php  echo htmlspecialchars($_SESSION['mess_manager_name']); ?></span>
        </div>
    </div>
        ...
        <div class="menu">
            <ul class="menu-links">
                ...
                $menu_items = [
                    ...
                    'mess_menu.php' => ['icon' => 'bx bx-menu', 'text' => ' Mess Menu'],
                    'mess_details.php' => ['icon' => 'bx bx-food-menu', 'text' => 'Student Details'],
