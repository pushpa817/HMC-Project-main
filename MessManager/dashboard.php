<?php
    ...
    $mess_manager_id = $_SESSION['mess_manager_id'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Dashboard | Mess Manager | HMC</title>
    ...
    <section class="main-content">
        <div class="profile-container">
            ...
            <div class="profile-info">
                ...
                $managerStmt = $conn->prepare("SELECT * FROM MessManager WHERE mess_manager_id = '$mess_manager_id'");
                $managerStmt->execute();
