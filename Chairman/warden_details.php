...
<head>
    ...
    <title>Warden Details| CHAIRMAN | HMC</title>
...
<body>
    ...
    <section class="main-content">
        ...
        $stmt = $conn->prepare("SELECT * FROM Wardens");
        $stmt->execute();
        $warden_details = $stmt->fetchAll(PDO::FETCH_ASSOC);

        foreach ($warden_details as $details) {
            echo "<div class='complaint-container'>";
            echo "<div class='complaint-header'>WARDEN ID: {$details['warden_id']}</div>";
            echo "<div class='complaint-detail'>WARDEN NAME: {$details['warden_name']}</div>";
            echo "<div class='complaint-detail'>Hall-ID: {$details['hall_id']}</div>";
            echo "<div class='complaint-detail'>Phone: {$details['phone']}</div>";
            echo "<div class='complaint-detail'>Email: {$details['email']}</div>";
