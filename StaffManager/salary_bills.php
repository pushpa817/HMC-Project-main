...
<head>
    ...
    <title>Salary | STAFF MANAGER | HMC</title>
...
<body>
    ...
    <section class="main-content">
        ...
        <table class="details-table" id="messDetailsTable">
            ...
            <tbody>
                <?php
                $stmt = $conn->prepare("SELECT staff_id,staff_name, role,attended_days,daily_pay FROM Staff");
                $stmt->execute();
